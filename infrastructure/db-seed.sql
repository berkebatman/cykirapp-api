...
VALUES ("1", "Gibson Les Paul", "6 telli gitar. En tiz nota mi olmakla birlikte en kalin nota da mi'dir ve bu ozelligiyle dikkat cekiyor.", 100, "../assets/images/gitar.png", "2021-5-20 12:00:00", 2, True, "Lefkosa", "Gonyeli", 1, 1);
INSERT INTO products (product_id, product_name, product_description, price, `image`, listed_at, rating, availability, product_city, product_town, user_id, category_id )
VALUES ("2", "Canon Camera Pix S Plus", "Dugun'de kullanilmamis sahibinden kiralik kamera. Tusu var, basarsiniz fotograf ceker; flashi var patlarsiniz; deligi var bakarsiniz; lensi var zoomlarsiniz. Instagram'da likelarinizi 15% oraninda artiracaginin kisisel garantisiyle birlikte kiraliktir.",  40, "../assets/images/kamera.png", "2021-4-20 12:00:00", 4, True, "Girne", "Alsancak", 3, 2);
INSERT INTO products (product_id, product_name, product_description, price, `image`, listed_at, rating, availability, product_city, product_town, user_id, category_id )
VALUES ("3", "Iphone 12", "Iphone'umu kiraya veriyorum. Dis mihraklar tarafindan, Amerika onderliginde suregelen ekonomik saldirilara artik dayanamiyorum. Yakmayi dusundum, ama icim bal vermedi. Kiradan gelir butun gelir AKTROLL 15 Temmuz Sehitler Koprusune tank almak icin kullanilacak olan fona aktarilacaktir.", 75, "../assets/images/iphone.png", "2021-5-22 12:00:00", 5, True, "Magusa", "Tuzla", 5, 3);
INSERT INTO products (product_id, product_name,product_description, price, `image`, listed_at, rating, availability, product_city, product_town, user_id, category_id )
VALUES ("4", "Bike", "Her bindigimde duserim. Iki terlekli gullanmaya alisamadim. Bu yuzdendir ki 2 tekerleli, bir dumenli ve bir oturgaclsi ve iki istoplu bisikletim kiralik olarak sizlerin kullanima aciktir. ", 40, "../assets/images/bike.png", "2021-5-16 12:00:00", 5, True, "Omorfo", "Kalkanli", 4, 4);
INSERT INTO products (product_id, product_name, product_description, price, `image`, listed_at, rating, availability, product_city, product_town, user_id, category_id )
VALUES ("5", "Camping tent", "Icinde sigara icilmemis, zina yapilmamis, keyif verici herhangi bir madde kullanilmamistir. Bayandan kiralik cadirdir. Satin alma opsiyonu da bulunmaktadir. Deneyin, memnun kalirsaniz arabada 15 evde 55 cadirda 25.",40, "../assets/images/tent.png", "2021-5-14 12:00:00", 5, True, "Omorfo", "Merkez", 5, 5);
INSERT INTO products (product_id, product_name, product_description, price, `image`, listed_at, rating, availability, product_city, product_town, user_id, category_id )
VALUES ("6", "Printer", "murekkepli, kagit ile calisan, elektrik de kullanan bu guzel alet kiraliktir. cevreye zarar verdigini dusndugum icin bu kagit yiyen makineyi kiraliyorum. Fiyata murekkebin maliyeti dahildir.", 40, "../assets/images/printer.png", "2021-5-18 12:00:00", 5, True, "Girne", "Lapta", 5, 6);
INSERT INTO products (product_id, product_name, product_description, price, `image`, listed_at, rating, availability, product_city, product_town,user_id, category_id )
VALUES ("7", "Footbal", "yuvarlak olan bu cisim ile insanoglu ayak topu diye ortaya cikan, sonralari futbol diye anilan spor brasini icra etmektedir. Bu top oyle bir toptur ki cetinkayadan yenicami sahasina gadar gider vurdugunuz da. kendisi has be has bir futbol topudur.", 40, "../assets/images/football.png", "2021-5-01 12:00:00", 5, True, "Lefke", "Yesilirmak", 5, 7);
INSERT INTO products (product_id, product_name, product_description, price, `image`, listed_at, rating, availability, product_city, product_town, user_id, category_id )
VALUES ("8", "Storage", "eviniz mi dar? yeriniz mi dar? yeriniz dar diye oynayamiyor musunuz? uzulmeyin, esyalariniz icin artik biz variz. bir kimiz? biz kuzey kibris turk ve daha da turk olan kara parcasinin ilk ve tek profosyonel depolama sirketiyiz. bu topraklarda hicbir turkun storagei yerde ve sahipsiz kalmayacak, bayragimiz hicbir zaman inmeyecek, ezan desibeli her yil 0.2db artarak seslendirilmeye devam edecek. Gelecegin Memurlari Partisi Genclik Kollarinin projesidir.", 40, "../assets/images/storage.png", "2021-5-04 12:00:00", 5, True, "Lefkosa", "Hamitkoy", 5, 8);
